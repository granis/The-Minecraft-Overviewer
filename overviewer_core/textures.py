...
# signposts
@material(blockid=[63,11401,11402,11403,11404,11405,11406,12505,12506,12509,12510,12511], data=list(range(16)), transparent=True)
def signpost(self, blockid, data):
    ...
    sign_texture = {
        ...
        12509: ("cherry_planks.png", "cherry_log.png"),
        12510: ("mangrove_planks.png", "mangrove_log.png"),
        12511: ("bamboo_planks.png", "bamboo_mosaic.png"),
    }
...
# wall signs
@material(blockid=[68,11407,11408,11409,11410,11411,11412,12507,12508,12512,12513,12514], data=[2, 3, 4, 5], transparent=True)
def wall_sign(self, blockid, data): # wall sign
    ...
    sign_texture = {
        ...
        12512: "cherry_planks.png",
        12513: "mangrove_planks.png",
        12514: "bamboo_planks.png",
    }
